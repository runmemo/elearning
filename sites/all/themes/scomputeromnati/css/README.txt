...
To use these stylesheets, rename the files and academyit with the name of your theme.
...
academyit-alpha-default-narrow.css  
...
academyit-alpha-default-normal.css
...
academyit-alpha-default-wide.css
