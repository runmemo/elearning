...
class CqQuestionSelectOrder extends CqQuestionAbstract {
  ...
  public function getForm($formState) {
    ...
    $wrapperName = 'cq-feedback-wrapper_' . $this->formElementName;
    $form[$wrapperName] = $this->getFeedbackFormItem();
    $form[$wrapperName]['#prefix'] = '<div id="cq-feedback-wrapper_' . $this->formElementName . '">';
    $form[$wrapperName]['#suffix'] = '</div>';
